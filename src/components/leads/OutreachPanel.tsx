          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {chatMessages.length === 0 && (
              <div className="text-center py-6 space-y-3">
                <div className="w-10 h-10 rounded-lg bg-secondary/40 flex items-center justify-center mx-auto">
                  <Bot className="w-5 h-5 text-violet-400" strokeWidth={1.75} />
                </div>
                <div>
          ...
          <div className="border-t border-border p-3">
            <div className="flex gap-2 items-end">
              <textarea
                ...
                rows={2}
                className="flex-1 resize-none bg-secondary/40 border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground"
              />
              <button
          ...
          <div className="space-y-4">
            {lead.qualificationScore !== null && (
              <div>
                ...
                <div className="flex items-center gap-3">
                  <span className={`text-2xl font-semibold tracking-tight tabular-nums ${(lead.qualificationScore ?? 0) >= 70 ? "text-emerald-400" : "text-muted-foreground"}`}>
                    {lead.qualificationScore}
                  </span>
                  <div className="flex-1 bg-secondary rounded-full h-1.5">
                    <div
                      className={`h-1.5 rounded-full ${(lead.qualificationScore ?? 0) >= 70 ? "bg-emerald-400" : "bg-muted-foreground"}`}
            ...
            {lead.email && (
              <div className="rounded-lg bg-secondary/40 px-3 py-3">
                ...
                <p className="text-xs tabular-nums mt-1">{lead.email}</p>
              </div>
            )}
          </div>
        )}
...
function OutreachBlock({
  ...
  return (
    <div className="bg-secondary/40 border border-border rounded-lg p-3 group">
