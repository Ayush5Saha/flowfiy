...
export default function SignupPage() {
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    // Meta Pixel signup conversion — the event the ad campaign optimizes toward.
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-8 shadow-2xl">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-lg text-sm font-medium hover:bg-secondary transition-colors disabled:opacity-50 mb-4"
      >
